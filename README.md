# comptaria.ca — site one-pager

Site web statique de comptaria.ca. Déployé sur Vercel via push GitHub.
...
curl -s https://ca-site.vercel.app/ | head -5
```
...
- Changer le placeholder `comptaria.ca` quand le nom officiel est choisi
- Mettre à jour `hello@ca.ca` quand le domaine est possédé
